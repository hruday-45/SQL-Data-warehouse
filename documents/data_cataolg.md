...
| **customer_zip_code_prefix** | `int` | First five digits of the Brazilian zip code. Note: Leading zeros are dropped due to Integer storage. | `14409`, `01001` |
...
| **is_repeat_customer** | `bit` | Flag indicating if the customer has $>1$ order. | `1`, `0` |
| **customer_tenure_days** | `int` | Total days elapsed between first and last purchase. | `0`, `150`, `432` |
| **dwh_create_date** | `datetime2(0)` | The exact timestamp when the table is created or altered. | `2017-10-02 10:56:33` |
...
| **month_name** | `nvarchar(20)` | Full name of the month. | `January`, `August` |
| **quarter** | `int` | Calendar quarter (1-4). | `1`, `2`, `3`, `4` |
| **year** | `int` | Four-digit calendar year. | `2016`, `2017`, `2018` |
| **is_weekend** | `bit` | Flag indicating if the date is a Saturday or Sunday (1=Yes, 0=No). | `1`, `0` |
| **is_holiday_brazil_flag** | `bit` | Flag indicating if the date is a Brazilian national holiday. | `1`, `0` |
| **dwh_create_date** | `datetime2(0)` | The exact timestamp when the table is created or altered. | `2017-10-02 10:56:33` |
...
| **geolocation_zip_code_prefix** | `int` | First five digits of the Brazilian zip code. Note: Leading zeros are dropped due to Integer storage. | `01001`, `20000` |
| **city** | `nvarchar(40)` | Full name of the city. | `sao Paulo`, `rio de janeiro` |
...
| **delivery_performance_status** | `varchar(20)` | Calculated status comparing actual vs estimated delivery. | `On Time`, `Late` |
| **dwh_create_date** | `datetime2(0)` | The exact timestamp when the table is created or altered. | `2017-10-02 10:56:33` |
...
| Column Name | Data Type | Description | Examples |
| :--- | :--- | :--- | :--- |
| **payment_key** | `int` | Unique surrogate key. | `41`, `1024` |
| **order_key** | `int` | Foreign key linking to `dim_orders`. | `41`, `1024` |
| **customer_key** | `int` | Foreign key linking to `dim_customers`. | `81684`, `5501` |
...
| Column Name | Data Type | Description | Examples |
| :--- | :--- | :--- | :--- |
| **review_key** | `int` | Unique surrogate key. | `41`, `1024` |
| **order_key** | `int` | Foreign key linking to `dim_orders`. | `41`, `1024` |
| **customer_key** | `int` | Foreign key linking to `dim_customers`. | `81684`, `5501` |
...
| Column Name | Data Type | Description | Examples |
| :--- | :--- | :--- | :--- |
| **sales_key** | `int` | Unique surrogate key. | `41`, `1024` |
| **order_key** | `int` | Foreign key linking to `dim_orders`. | `41`, `1024` |
| **customer_key** | `int` | Foreign key linking to `dim_customers`. | `81684`, `5501` |
| **seller_key** | `int` | Foreign key linking to `dim_sellers`. | `1054`, `982` |
| **product_key** | `int` | Foreign key linking to `dim_products`. | `1415`, `2203` |
...
| **order_status** | `nvarchar(20)` | Current status of the order. | `DELIVERED`, `SHIPPED` |
...
| **is_shipped_flag** | `bit` | 1 if shipped, 0 otherwise. | `1`, `0` |
| **is_delivered_flag** | `bit` | 1 if delivered, 0 otherwise. | `1`, `0` |
| **is_late_delivery_flag** | `bit` | 1 if delivered after estimate, 0 otherwise. | `0`, `1` |
| **dwh_create_date** | `datetime2(0)` | The exact timestamp when the table is created or altered. | `2017-10-02 10:56:33` |
