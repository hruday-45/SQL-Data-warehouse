...
BEGIN
	...
	FROM bronze.olist_customers_dataset;
		PRINT '---> Rows in bronze.olist_customers_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_geolocation_dataset;
		PRINT '---> Rows in bronze.olist_geolocation_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_order_items_dataset;
		PRINT '---> Rows in bronze.olist_order_items_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_order_payments_dataset;
		PRINT '---> Rows in bronze.olist_order_payments_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_order_reviews_dataset;
		PRINT '---> Rows in bronze.olist_order_reviews_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_orders_dataset;
		PRINT '---> Rows in bronze.olist_orders_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_products_dataset;
		PRINT '---> Rows in bronze.olist_products_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.olist_sellers_dataset;
		PRINT '---> Rows in bronze.olist_sellers_dataset: ' + CAST(@rows AS NVARCHAR);
	...
	FROM bronze.product_category_name_translation;
		PRINT '---> Rows in bronze.product_category_name_translation: ' + CAST(@rows AS NVARCHAR);
