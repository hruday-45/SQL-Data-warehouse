...
DROP TABLE IF EXISTS silver.customers_info;
...
DROP TABLE IF EXISTS silver.geolocation_info;
...
DROP TABLE IF EXISTS silver.orders_info;
...
DROP TABLE IF EXISTS silver.products_info;
...
DROP TABLE IF EXISTS silver.sellers_info;
...
DROP TABLE IF EXISTS silver.state_centers;
