...
BEGIN
	...
	FROM silver.customers_info;
		PRINT '---> Rows in silver.customers_info: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.geolocation_info;
		PRINT '---> Rows in silver.geolocation_info: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.order_items;
		PRINT '---> Rows in silver.order_items: ' + CAST(@rows AS NVARCHAR);
        ...
        PRINT '---> Inserting Data Info: silver.order_payments';
	...
	FROM silver.order_payments;
		PRINT '---> Rows in silver.order_payments: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.order_reviews;
		PRINT '---> Rows in silver.order_reviews: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.orders_info;
		PRINT '---> Rows in silver.orders_info: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.product_category_name_translation;
		PRINT '---> Rows in silver.product_category_name_translation: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.products_info;
		PRINT '---> Rows in silver.products_info: ' + CAST(@rows AS NVARCHAR);
	...
	FROM silver.sellers_info;
		PRINT '---> Rows in silver.sellers_info: ' + CAST(@rows AS NVARCHAR);
	...
	VALUES
		...
		SELECT @rows = COUNT(*)
	FROM silver.state_centers;
		PRINT '---> Rows in silver.state_centers: ' + CAST(@rows AS NVARCHAR);
